        ...
        <section className="relative py-12 sm:py-16 md:py-20 lg:py-28 overflow-hidden">
          ...
          <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              >
                <span className="text-primary">Piston Pins</span>
              </motion.h1>
              <motion.p
                variants={fadeIn}
                className="text-base sm:text-lg md:text-xl text-muted-foreground"
              >
                Exported to over 50 countries, our piston pins deliver optimal
                load distribution and reduced friction for global automotive
                manufacturers.
              </motion.p>
            </motion.div>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 sm:gap-12 items-center">
              ...
              >
                ...
                <p className="text-sm sm:text-base text-muted-foreground">
                  Meghdoot Pistons uses premium piston pins that are fitted with
                  pistons and exported to automotive aftermarket across the
                  globe. Our pins are designed to provide optimal load
                  distribution, reduced friction, and extended service life in
                  all operating conditions.
                </p>
                <p className="text-sm sm:text-base text-muted-foreground">
                  Using advanced materials and precision manufacturing
                  techniques, our piston pins offer superior strength, wear
                  resistance, and dimensional stability. Each pin undergoes
                  rigorous testing to meet international quality standards and
        ...
        <section className="py-12 sm:py-16">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              >
                Contact our export team to discuss your specific requirements
                and discover how our products can enhance your engine
